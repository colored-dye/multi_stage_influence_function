"""∇_θ L(z_test, θ_ft)^T H_θ_ft^(-1) H_θ_pre^(-1) ∇_θ L(z_pre, θ_pt)"""
...
results_dir = "../trace/bloom_two_stages_infl_candidates/"
...
def main():
    ...
    factors = {"pt": {}, "ft": {}}
    factors['pt']['QA'], factors['pt']['QG'], factors['pt']['Lambda'] = load_factors("factors_pretrain")
